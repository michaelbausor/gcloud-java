...
for version in versions:
    ...
    s.copy(library / f'grpc-google-cloud-{service}-{version}-java/src', f'../../google-api-grpc/grpc-google-cloud-{service}-{version}/src')
    s.copy(library / f'proto-google-cloud-{service}-{version}-java/src', f'../../google-api-grpc/proto-google-cloud-{service}-{version}/src')
